...
<head>
    ...
    <script language="javascript" src="editLoanIdList.js"></script>
...
//    dbGrid.setWhereStr(" order by b.mortdate desc,a.cust_py asc ");
    ...
    dbGrid.setbuttons("导出Excel=excel,查看贷款=loanQuery,查看抵押=query,编辑抵押=editRecord,moveFirst,prevPage,nextPage,moveLast");
%>
