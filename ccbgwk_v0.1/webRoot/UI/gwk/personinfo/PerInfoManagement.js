...
//	Table_Refresh("PerInfoTab", false);
//	initDBGrid("PerInfoTab");
//    alert(document.getElementById("cellButtons").innerHTML);
}
...
//        whereStr += " or (a.cust_py  like'" + trimStr(document.getElementById("cust_name").value) + "%'))";
    ...
    if (trimStr(document.getElementById("personalID").value) != ""){
        whereStr += "and p.perid = '" + trimStr(document.getElementById("personalID").value) + "'";
    }
    if (trimStr(document.getElementById("departmentID").value) != ""){
        whereStr += " and lg.name like '%" + trimStr(document.getElementById("departmentID").value) + "%'";
    }
...
function PerInfoTab_deleteRecord_click() {
    ...
    if (trobj.cells[0].children[0] != undefined && trobj.cells[0].children[0].checked){
