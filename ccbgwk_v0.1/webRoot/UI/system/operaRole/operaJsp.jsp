...
<BODY  onload="changeheigth();onUserDocumentLoad();"  onresize="changeheigth()" oncontextmenu="event.returnValue=false;" class="Bodydefault">
		...
		<table style="WIDTH:100%;HEIGHT:10%;left:0px" cellspacing="0" ID="Table1">
			<tr>
				<td colspan="2" class="borderGrooveB">
					<font face="SimSun" style="FONT-WEIGHT: bold; FONT-SIZE: 18pt"><img class="shadowAlpha" align="absMiddle" src="/images/frame/domain.gif" width="48" height="48">»À‘± ⁄»®</font>
				</td>
			</tr>
		</table>
			<table style="WIDTH:100%;HEIGHT:96%;left:0px" cellspacing="0" ID="Table1">

               <tr>
				<td  class="borderGrooveBRL"  style="WIDTH:320px;height:100%" >
					<ul   id="rootUl" style="OVERFLOW:auto;WIDTH:97%;left:-30px;POSITION: absolute;top:12%" onmousemove = "tv_OnMouseMove()"	onmousedown = "tv_OnMouseDown()" onmouseup = "tv_OnMouseUp()"></ul>
				</td>
