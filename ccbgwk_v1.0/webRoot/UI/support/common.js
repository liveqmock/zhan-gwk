...
function showMessageDialog(text, center)
{
	...
	//_dialogWin=showModelessDialog("/UI/cims/qydj/messageDialog.htm",text,"dialogWidth:300px;dialogHeight:50px;help:no;scroll:no;status:no;center:yes;");
...
function showHelp( idHelp )
{
	...
	switch( idHelp )
	{
		case "sl":
		case "hz":
			URL="/UI/cims/qydj/help/help_slhz.htm";
			break;
		case "yd":
		case "rd":
			URL="/UI/cims/qydj/help/help_ydrd.htm";
			break;
	}
	window.open(URL);
}
