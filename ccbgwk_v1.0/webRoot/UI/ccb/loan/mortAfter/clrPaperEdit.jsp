...
<title>贷款结清取证登记</title>
<script language="javascript" src="/UI/support/tabpane.js"></script>
<script language="javascript" src="/UI/support/common.js"></script>
<script language="javascript" src="/UI/support/DataWindow.js"></script>
<script language="javascript" src="/UI/support/pub.js"></script>
<script language="javascript" src="clrPaperEdit.js"></script>
</head>
<body bgcolor="#ffffff" onLoad="formInit();"  class="Bodydefault" >
<div id="container">
  <form id="editForm" name="editForm" >
    <fieldset >
    <legend>贷款结清取证登记</legend>
    <table width="100%"  cellspacing="0" border="0">
      ...
      <!-- 抵押登记状态 -->
      <%--<input type="hidden" id="MORTSTATUS" value="<%=CcbLoanConst.NODE_CLR_PAPER %>"/>--%>
      ...
      <tr>
        <td width="20%" nowrap="nowrap" class="lbl_right_padding">贷款结清取证日期</td>
        <td width="30%" colspan="3" class="data_input"><input  name="CLRPAPERDATE"  type="text" id="CLRPAPERDATE"  style="width:33%" onClick="WdatePicker()" fieldType="date" isNull="false">
