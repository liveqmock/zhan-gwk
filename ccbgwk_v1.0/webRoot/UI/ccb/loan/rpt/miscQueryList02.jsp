...
<head>
    ...
    <title></title>
    <script language="javascript" src="miscQueryList02.js"></script>
...
<fieldset style="padding:40px 25px 0px 25px;margin:0px 20px 0px 20px">
    ...
    <legend>查询条件</legend>
        ...
        <form id="queryForm" name="queryForm">
            <%--
                        <!-- 组合查询统计类型一 -->
                        <input type="hidden" value="miscRpt02" id="rptType" name="rptType"/>
                        <tr>
                            <td width="15%" nowrap="nowrap" class="lbl_right_padding">抵押接收日期</td>
                            <td width="14%" nowrap="nowrap" class="data_input"><input type="text" id="MORTEXPIREDATE"
                                                                                      name="MORTEXPIREDATE" onClick="WdatePicker()"
                                                                                      fieldType="date" size="20"></td>
                            <td width="2%" nowrap="nowrap" class="lbl_right_padding">至</td>
                            <td width="54%" nowrap="nowrap" class="data_input"><input type="text" id="MORTEXPIREDATE2"
...
<div class="help-window">
    ...
    <div class="help-info">
        <ul>
            <li>可实现按合作项目、经办行、未办妥抵押原因统计某一时间段内签约放款已放款未回证的清单.</li>
