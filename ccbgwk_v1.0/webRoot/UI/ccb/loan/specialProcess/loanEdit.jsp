...
<fieldset>
    ...
    <table width="100%" cellspacing="0" border="0">
        ...
        <tr>
            ...
            <td width="35%" colspan="3" class="data_input"><input type="text" id="loanID" name="loanID" value=""
                                                                  intLength="24"
                                                                  style="width:96.4% " isNull="false">
        ...
        <tr>
            ...
            <td width="35%" class="data_input"><input type="text" id="RT_ORIG_LOAN_AMT" name="RT_ORIG_LOAN_AMT" value=""
                                                      style="width:90%" intLength="18" floatLength="2"
                                                      isNull="false">
                <span class="red_star">*</span></td>
            <%--
