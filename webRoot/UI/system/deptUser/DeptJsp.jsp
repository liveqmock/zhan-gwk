...
<BODY  onload="changeheigth();onUserDocumentLoad();" onclick="body_Click()" onresize="changeheigth()"  oncontextmenu="event.returnValue=false;" class="Bodydefault">
		<input type="hidden" id="paramValue" NAME="paramValue">

		<table style="WIDTH:100%;HEIGHT:10%;PADDING-LEFT: 0px" cellspacing="0" ID="Table1">
			<tr >
				<td colspan="2"  class="borderGrooveB">
					<font face="SimSun" style="FONT-WEIGHT: bold; FONT-SIZE: 18pt"><img class="shadowAlpha" align="absMiddle" src="/images/frame/domain.gif" width="48" height="48">机构管理</font>
				</td>
			</tr>
		</table>
        <table style="WIDTH:100%;HEIGHT:90%;PADDING-LEFT: 0px"  ID="Table1">
        	<tr>
