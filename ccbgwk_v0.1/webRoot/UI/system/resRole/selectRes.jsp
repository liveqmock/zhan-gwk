  ...
  <LINK href="/css/ccb.css" type="text/css" rel="stylesheet">
   ...
   <script language="javascript">
    ...
    if (retStr != false && retStr !="false")
    {
      ...
      treeRoot =  tree.node.add("", "", "0", "资源列表", "/images/frame/domain.gif");
...
function showApplications(eleRoot, nFather, bManagedApp)
{
  ...
  while(node)
  {
      var nApp = nFather.add("tvwChild", decode(getAttrValue(node.childNodes[0],"value")), decode(getAttrValue(node.childNodes[1],"value")), "/images/frame/user.gif");
...
<body bgcolor="#ffffff" onload="load_Role();" class="Bodydefault">
  <table style="WIDTH:100%;HEIGHT:100%;left:0px" cellspacing="0" ID="Table1">
        ...
        <td class="borderGrooveB">
          <font face="SimSun" style="FONT-WEIGHT: bold; FONT-SIZE: 18pt"><img class="shadowAlpha" align="absMiddle" src="/images/frame/domain.gif" width="48" height="48">资源列表</font>
        </td>
      </tr>
