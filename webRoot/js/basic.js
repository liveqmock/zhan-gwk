...
function print_DBGrid(id){
	...
	if (tab.RecordCount/1>=2000)
	{
	 ...
	 var arguments = "/UI/system/public/print/makeprt.jsp";
...
function allprint_DBGrid(id){
	...
	if (tab.RecordCount/1==0)
	{
	 ...
	 var arguments = "/UI/system/public/print/allmakeprt.jsp";
...
function  aicRefresh_select(selectId,refSql,defaultValue,defaultTitle){
     ...
     var retStr = ExecServerPrgm("/BI/util/AicSqlSelectJsp.jsp","POST","sys_request_xml="+xmlDoc.xml);
