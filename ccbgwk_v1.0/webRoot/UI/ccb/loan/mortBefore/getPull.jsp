...
<%
  ...
  // 模糊查询匹配规则：前端一�?
  RecordSet rs=conn.executeQuery("select * from (select a.loanid,a.cust_name,a.cust_py from ln_loanapply a "
      +" where  exists (select 1 from  "
      +" ln_mortinfo b where b.loanid=a.loanid  and b.mortstatus='"+CcbLoanConst.MORT_FLOW_REGISTED+"' )  and ((a.cust_name like'"+strPara+"%') or (a.cust_py  like'"+strPara+"%')) "
