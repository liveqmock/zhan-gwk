...
<%@ page import="pub.platform.html.*,com.pub.util.*" %>
<%
...
<LINK href="/css/catv.css" type="text/css" rel="stylesheet">
    ...
    <script language="javascript" src="/js/getDeptuser.js"></script>
    
       <script language="javascript" src="/js/JComboBox.js"></script>
</head>
...
<script language="javascript">
	...
	function birthdayadd(){
		...
		//window.location.href =	"/ui/birthday.xls";
		window.open("/ui/birthday.xls")	
	...
	function getdept(){
			 var arguments = "/UI/system/deptUser/getUserJsp.jsp";
