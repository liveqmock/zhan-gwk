...
<script language="javascript" src="otherBankNoMortEdit.js"></script>
</head>
<body bgcolor="#ffffff" onLoad="formInit();"  class="Bodydefault" >
<div id="container"> <br>
  <form id="editForm" name="editForm" >
    <fieldset >
    <legend>他行开发贷不可报抵押交接登记</legend>
    ...
    <tr>
      ...
      <td width="30%" class="data_input">
        <%
        ZtSelect zs = new ZtSelect("BANKFLAG", "BANKFLAG", "1");
      ...
      <td width="20%" nowrap="nowrap" class="lbl_right_padding">可报抵押标志</td>
      <td width="30%" class="data_input">
        <%
    ...
    <tr>
      <td width="20%" nowrap="nowrap" class="lbl_right_padding">不可报抵押交接标志</td>
      <td width="30%" colspan="3" class="data_input">
        <%
        zs = new ZtSelect("RELAYFLAG", "RELAYFLAG", "1");
        zs.addAttr("style", "width: 33%");
        zs.addAttr("fieldType", "text");
        zs.addAttr("isNull", "false");
        //zs.addOption("", "");
        //zs.setDisplayAll(false);
...
--%>
      <tr>
        ...
        <td width="30%" class="data_input"><%
                  ZtSelect zs = new ZtSelect("SENDFLAG", "SENDFLAG", "0");
                  zs.addAttr("style", "width: 90%");
                  zs.addAttr("fieldType", "text");
                  zs.addAttr("isNull", "false");
                  //zs.addOption("", "");
        ...
        <td width="20%" nowrap="nowrap" class="lbl_right_padding">不可报抵押登记时间</td>
        <td width="30%" class="data_input"><input name="RPTNOMORTDATE" type="text" id="RPTNOMORTDATE"
