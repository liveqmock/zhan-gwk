...
<head>
    ...
    <script language="javascript" src="clrPaperList.js"></script>
...
//        dbGrid.setField("机构", "text", "6", "deptname", "true", "0");
    ...
    dbGrid.setField("抵押状态", "dropdown", "8", "mortregstatus", "true", "MORTREGSTATUS");
...
//        dbGrid.setWhereStr(" order by a.cust_py asc ");
    ...
    dbGrid.setbuttons("查看贷款=loanQuery,查看抵押=query,结清取证=editRecord,moveFirst,prevPage,nextPage,moveLast");
%>
            ...
            <tr height="20">
                <%--
                          ...
                          <td width="70%" align="right" nowrap="nowrap" class="data_input" >
                            <input type="text" id="cust_name" size="40" class="ajax-suggestion url-getClrPull.jsp">
                          </td>
                --%>
