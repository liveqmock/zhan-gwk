...
<form id="editdept">
 ...
 <legend>编辑菜单</legend>
 		<table align="center" valign="center" cellspacing="0" border="0" width="100%">
               ...
               <tr><td class="lbl_right_padding" nowrap="nowrap">父健菜单</td><td class="data_input" style="width:90%" >
                    <%
			...
			<tr><td class="lbl_right_padding">菜单名称</td><td class="data_input"><input class="text" id="menulabel" style="width:90%"   fieldName="menulabel" isNull="false" textLength="50" fieldType="text" type="text"></td></tr>
			<tr><td class="lbl_right_padding">显示顺序</td><td class="data_input"><input class="text" id="levelindex" style="width:90%"   fieldName="levelindex" isNull="false" textLength="50" fieldType="text" type="text"  onkeypress="onKeyPressInputInteger()">  </td></tr>
            <tr><td class="lbl_right_padding">菜单描述</td><td class="data_input"><textarea style="width:90%" id="menudesc" fieldName="menudesc"  fieldType="text"  textLength="200"  type="text" rows="4"></textarea></td></tr>
