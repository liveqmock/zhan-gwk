...
<head>
    ...
    <script language="javascript" src="chgRtnPaperEdit.js"></script>
</head>
<body bgcolor="#ffffff" onLoad="formInit();" class="Bodydefault">
<div id="container">
    <form id="editForm" name="editForm">
        <fieldset>
            <legend>借证归还登记</legend>
            <table width="100%" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td width="30%" colspan="3" class="data_input"><%
                        ZtSelect zs = new ZtSelect("MORTREGSTATUS", "MORTREGSTATUS", "");
