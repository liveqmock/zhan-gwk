...
function loanRegistedTab_editRecord_click() {
    ...
    var sfeature = "dialogwidth:800px; dialogheight:200px;center:yes;help:no;resizable:yes;scroll:no;status:no";
    var tab = document.all["loanRegistedTab"];
    var trobj = tab.rows[tab.activeIndex];
    ...
    // 抵押编号
    arg.mortID = mortID;
    var ret = dialog("/UI/ccb/loan/specialProcess/editLoanIdEdit.jsp?mortID=" + mortID + "&doType=edit", arg, sfeature);
