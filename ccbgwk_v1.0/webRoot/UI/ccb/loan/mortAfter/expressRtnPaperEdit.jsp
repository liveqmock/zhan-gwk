...
<script language="javascript" src="expressRtnPaperEdit.js"></script>
</head>
<body bgcolor="#ffffff" onLoad="formInit();"  class="Bodydefault" >
<div id="container"> <br>
  <form id="editForm" name="editForm" >
    <fieldset >
    <legend>快递回证登记</legend>
    <table width="100%"  cellspacing="0" border="0">
      ...
      <tr>
        ...
        <td width="30%" class="data_input"><input  name="EXPRESSRTNDATE"  type="text" id="EXPRESSRTNDATE"  style="width:90%" onClick="WdatePicker()" fieldType="date" isNull="false">
      ...
      <tr>
        ...
        <td width="30%" colspan="3" class="data_input"><textarea rows="3" style="width:96.4%" id="EXPRESSNOTE" textLength="500"></textarea>
        </td>
      </tr>
      <tr>
