...
<title></title>
<script language="javascript" src="payBillList12.js"></script>
...
<fieldset style="padding-top:-5px;padding-bottom:0px;margin-top:0px">
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
        <form id="queryForm" name="queryForm">
            <tr>
                <td width="15%" nowrap="nowrap" class="lbl_right_padding">开户日期起</td>
                ...
                <td width="54%" nowrap="nowrap" class="data_input"><input type="text" id="CUST_OPEN_DT2"
                                                                          name="CUST_OPEN_DT2" onClick="WdatePicker()"
                                                                          fieldType="date" size="20"></td>
                <td colspan="8" nowrap="nowrap" align="right"><input name="expExcel" class="buttonGrooveDisableExcel"
                                                                     type="button" onClick="loanTab_expExcel_click()"
                                                                     value="导出excel">
