...
<head>
    ...
    <script language="javascript" src="mortRtnPaperList.js"></script>
...
<%
    ...
    String sql = "select b.MORTECENTERCD, (select deptname from ptdept where deptid=a.bankid) as deptname," +
            "a.loanid,a.cust_name,a.RT_ORIG_LOAN_AMT,b.mortid,b.PAPERRTNDATE,b.MORTREGSTATUS,"
            + " a.nbxh "
            + " from ln_loanapply a,ln_mortinfo b where  "
            + " a.loanid = b.loanid and (b.mortstatus='" + CcbLoanConst.MORT_FLOW_REGISTED + "' " +
            " or b.mortstatus='" + CcbLoanConst.MORT_FLOW_RETURN + "' " +
            " or b.mortstatus='" + CcbLoanConst.MORT_FLOW_RETURNNOTE + "' " +
            ")   "
            + "  ";
    ...
    dbGrid.setField("抵押登记状态", "dropdown", "10", "MORTREGSTATUS", "true", "MORTREGSTATUS");
    ...
    dbGrid.setbuttons("查看贷款=loanQuery,查看抵押=query,入库登记=editRecord,moveFirst,prevPage,nextPage,moveLast");
%>
