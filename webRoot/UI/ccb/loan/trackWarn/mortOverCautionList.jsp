...
<head>
    ...
    <title></title>
    <script language="javascript" src="mortOverCautionList.js"></script>
...
<%
    ...
    // 抵押超批复日期=当前日期 ，进行抵押超批复时限预警
    String comSql = ""
            // 签约放款，账户必须为：已开户，放款方式：签约放款的数据
            + " select * from ( "
            + " select b.MORTDATE,"
    ...
    String tempWhere1 = " and to_char(overdate,'yyyy-mm-dd') <= '" + currentDate + "'";
