...
<%
  ...
  // 模糊查询匹配规则：前端一致
  RecordSet rs=conn.executeQuery("select * from (select a.loanid,a.cust_name,a.cust_py from ln_loanapply  a where "
      ...
      +" and ((a.cust_name like'"+strPara+"%') or (a.cust_py  like'"+strPara+"%')) order by a.CUST_OPEN_DT desc,APLY_DT desc,a.cust_py asc "
