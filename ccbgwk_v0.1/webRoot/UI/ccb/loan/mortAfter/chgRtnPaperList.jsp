...
<head>
    ...
    <script language="javascript" src="chgRtnPaperList.js"></script>
...
<%
    ...
    String sql = "select b.MORTECENTERCD,  (select deptname from ptdept where deptid=a.bankid) as deptname," +
            "a.loanid,a.cust_name,a.RT_ORIG_LOAN_AMT,b.mortid,b.CHGPAPERRTNDATE,"
            + " a.nbxh "
            + " from ln_loanapply a,ln_mortinfo b where  "
            + " a.loanid = b.loanid and b.MORTSTATUS='" + CcbLoanConst.MORT_FLOW_CHANGED + "'  "
            + "  ";
    ...
    dbGrid.setField("借证归还日期", "center", "8", "CHGPAPERRTNDATE", "true", "0");
    ...
    dbGrid.setbuttons("查看贷款=loanQuery,查看抵押=query,借证归还=editRecord,moveFirst,prevPage,nextPage,moveLast");
%>
        ...
        <form id="queryForm" name="queryForm">
            <tr height="20">
                ...
                <td width="70%" align="right" nowrap="nowrap" class="data_input">
                    <input type="text" id="cust_name" size="40" class="ajax-suggestion url-chgRtnPaperPull.jsp">
                </td>--%>
