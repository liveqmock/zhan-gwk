...
function formInit() {
    ...
    // 设置默认焦点；借证领用日期
    if (operation != "select") {
        document.getElementById("CHGPAPERDATE").focus();
    }
}
...
function saveClick() {
    ...
    if (operation == "add") {
        ...
        // 已借证取证 40
        var MORT_FLOW_CHANGED = "40";
        document.getElementById("MORTSTATUS").value = MORT_FLOW_CHANGED;
        document.getElementById("busiNode").value = BUSINODE_090;
