...
<head>      
    ...
    <script type="text/javascript">
        ...
        function switchSysBar() {
            ...
            {
                window.status = 0;
                //                document.getElementById("switchPoint").innerHTML = '<img src="/images/rightarrow.gif" title="展开左栏" />';
            ...
            {
                window.status = 1;
                //                document.getElementById("switchPoint").innerHTML = '<img src="/images/leftarrow.gif" title="隐藏左栏" />';
                document.getElementById("switchPoint").innerHTML = '<img src="../../images/splitter_l.gif" title="隐藏左栏" align="right" />';
                parent.document.getElementById("menuFrame").cols = "180,12,*";
            }
        }
    </script>
</head>
<%--<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" scroll="no" style="background-color:#cddcf0">--%>
<body leftmargin="0" topmargin="0" rightmargin="0" bottommargin="0" scroll="no" background="<%=path %>/images/splitter_bg.gif">
            ...
            <table cellSpacing="0" cellPadding="0" border="0">
                <tr onclick="switchSysBar()" height="100%">
                    <td onmouseover="this.style.cursor='hand'" onmouseout="this.style.cursor='default'" title="隐藏菜单"
                        ...
                        <%--<span id="switchPoint"><img src="/images/leftarrow.gif" title="隐藏左栏">--%>
                        <span id="switchPoint"><img src="<%=path %>/images/splitter_l.gif" title="隐藏左栏" align="right"></span>
                    </td>
                </tr>
            </table>
        </td>
