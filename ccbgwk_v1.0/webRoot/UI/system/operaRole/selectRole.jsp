	  ...
	  function load_Role(){
		...
		if (retStr != false)
		{
			...
			var Root = domdoc.documentElement;
			 ...
			 nRoot =  tree.node.add("", "", "0", "角色列表", "/images/frame/domain.gif");
	...
	<table style="WIDTH:100%;HEIGHT:100%;left:0px" cellspacing="0" ID="Table1">
              <tr style="HEIGHT:64px">
				<td class="borderGrooveB">
					<font face="SimSun" style="FONT-WEIGHT: bold; FONT-SIZE: 18pt"><img class="shadowAlpha" align="absMiddle" src="/images/frame/domain.gif" width="48" height="48">角色列表</font>
				</td>
			</tr>
